...
class Calculator extends Component {
  ...
  handleModulo() {
    this.setState({
      number: this.state.number ? Number(this.state.number / 100).toFixed(5) : "",
      result: this.state.result ? Number(this.state.result / 100).toFixed(5) : "",
    });
  }
    ...
    return (
      <div className="calculator">
        ...
        <div className="calculator-buttons">
          ...
          <CalculatorButton value="%" className="calculator-operation-button" onClick={this.handleModulo} />
...
class CalculatorButton extends Component {
  render() {
    ...
    return (
      <button value={0} className={'calculator-button ' + className} onClick={onClick} disabled={disabled}>
        {value}
      </button>
    );
  }
